...
def experiment_FI(now=None, models=None, servers=None, horizons=None, seeds=[1]):
...
experiment_FI(now=now, servers=servers, horizons=horizons, models=models, seeds=seeds)
