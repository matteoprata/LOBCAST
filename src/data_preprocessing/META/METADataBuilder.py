...
class MetaDataBuilder:
    ...
    def __plot_corr_matrix(self):
        ...
        heatmap.set(title=f"Correlation matrix for K={self.fiw}")

        heatmap.figure.set_size_inches(10, 9)

        # save heatmap as PNG file
        heatmap.figure.savefig(f"data/correlation_matrix_K={self.fiw}.png", dpi=1000, bbox_inches='tight')
        plt.show()
    ...
    def __plot_agreement_matrix(self):
        ...
        ax.set_title(f'Agreement matrix for K={self.fiw}', fontsize=12)
        ...
        for i in range(self.n_models):
            for j in range(self.n_models):
                ...
                ax.text(i, j, str(round(c, 2)), va='center', ha='center', fontsize=9)

        plt.show()
        fig.savefig(f"data/agreement_matrix_K={self.fiw}.png", dpi=1000, bbox_inches='tight')
